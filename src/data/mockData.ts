import type { Agent, Device, EscalationRule, InteractionLog, StoreLocation, Ticket } from '../types'
...
export const mockTickets: Ticket[] = [
  {
    id: 't1',
    ticketNumber: 'IT-24001',
    title: 'POS lane 2 frozen during lunch rush',
    storeId: 's1',
    requester: 'Dana Ruiz',
    channel: 'Call',
    priority: 'P1',
    ...
    slaDue: 'Today 12:25 PM',
    createdAt: '2026-08-08T09:12:00.000Z',
    updatedAt: '2026-08-08T09:19:00.000Z',
    summary: 'Register accepts cash but card reader times out. Auto-escalated because impact is revenue-blocking during peak period.',
    autoLogged: true,
    escalationReason: 'Revenue-blocking POS failure with active customer queue',
  },
  {
    id: 't2',
    ticketNumber: 'IT-24002',
    title: 'Drive-thru headset audio crackling',
    storeId: 's2',
    requester: 'Chris Nolan',
    channel: 'Chat',
    priority: 'P2',
    status: 'Triaging',
    category: 'Audio',
    assignedTo: 'Maya Patel',
    slaDue: 'Today 1:10 PM',
    createdAt: '2026-08-08T09:22:00.000Z',
    updatedAt: '2026-08-08T09:30:00.000Z',
    summary: 'Headset base station drops every 3 minutes; workaround uses front counter speaker.',
    autoLogged: true,
  },
  {
    id: 't3',
    ticketNumber: 'IT-24003',
    title: 'Back office PC cannot print end-of-day report',
    storeId: 's3',
    requester: 'Lena Wong',
    channel: 'Call',
    priority: 'P3',
    ...
    slaDue: 'Tomorrow 9:00 AM',
    createdAt: '2026-08-08T08:11:00.000Z',
    updatedAt: '2026-08-08T08:45:00.000Z',
    summary: 'Printer spooler clears but job remains pending; vendor cartridge sensor alert logged.',
    autoLogged: true,
  },
  {
    id: 't4',
    ticketNumber: 'IT-24004',
    title: 'Menu board player offline',
    storeId: 's4',
    ...
    assignedTo: 'Sam Brooks',
    slaDue: 'Today 2:30 PM',
    createdAt: '2026-08-08T10:01:00.000Z',
    updatedAt: '2026-08-08T10:01:00.000Z',
    summary: 'Monitoring detected signage player offline for 18 minutes; reboot command failed.',
    autoLogged: true,
  },
  {
    id: 't5',
    ticketNumber: 'IT-24005',
    title: 'Inventory tablet battery swelling',
    storeId: 's6',
    ...
    assignedTo: 'Sam Brooks',
    slaDue: 'Today 11:45 AM',
    createdAt: '2026-08-08T09:41:00.000Z',
    updatedAt: '2026-08-08T09:48:00.000Z',
    summary: 'Agent instructed store to power down and isolate device. Escalated to field dispatch for same-day replacement.',
    autoLogged: true,
    escalationReason: 'Safety risk from swollen battery',
  },
  {
    id: 't6',
    ticketNumber: 'IT-24006',
    title: 'Wi-Fi guest portal showing certificate warning',
    storeId: 's5',
    ...
    category: 'Network',
    assignedTo: 'Jordan Ellis',
    slaDue: 'Yesterday 4:00 PM',
    createdAt: '2026-08-07T13:10:00.000Z',
    updatedAt: '2026-08-07T14:06:00.000Z',
    summary: 'Portal cert chain refreshed; store verified customer access.',
    autoLogged: false,
  },
]
